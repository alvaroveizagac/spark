...
object MainSentiment {
  ...
  def main(args:Array[String]): Unit  = 
  {
    ...
    generateUpdatesLexiconAvg(wordsLexiconLabelsSentWordnetToken, lblTimeStamp, "AVGSentWordNetTokens.csv")
    generateUpdatesLexiconAvg(wordsLexiconLabelsSentwordnetTweet, lblTimeStamp, "AVGSentWordNetTweets.csv")
    
    println("generating the updates for the lexicon case PMI case tweets")
    generateUpdatesLexiconPmi(false, filterLabeledDatasetShort, sc, wordsLexiconLabelsSentwordnetTweet,
        "tweets", lblTimeStamp, "SentiWordNetPMITweets.txt")    
    generateUpdatesLexiconPmi(false, filterLabeledDatasetShort, sc, wordsLexiconLabelsSentWordnetToken,
        "tokens", lblTimeStamp, "SentiWordNetPMITokens.txt")
  ...
  def assignSentimentDataset(dataset:RDD[String], labelMonth:String):RDD[String] =
  {
    ...
    labeledDataset.saveAsTextFile(PrParameters.projectFolder+labelMonth+"sentimentDataset.csv")
  ...
  def storeHashTags(labeledDataset:RDD[String], label:String) =
  {
    ...
    rddHashTags.filter(line => PostFilterTweetsWords.hasInnecesaryWords(line))
               .saveAsTextFile(PrParameters.projectFolder+label+"HashTags.csv")           
  ...
  def combineWordsNotLexiconTokens(labeledDatasetNoBlank:RDD[String], sc:SparkContext, label:String)=
  {
    ...
    groupWordsNoSentLabelsSentwordnet.saveAsTextFile(PrParameters.projectFolder+label+"WordsNoSentimentImplComb.csv")
    val groupWordsNoSentLabelsDistSup = PostCombWordsNoSent.groupWordsNoSentiment(filterWordsNoSentLabelsDistSup,sc)
    groupWordsNoSentLabelsDistSup.saveAsTextFile(PrParameters.projectFolder+label+"WordsNoSentimentOrigComb.csv")
  ...
  def combineWordsNotLexiconTweets(labeledDatasetNoBlank:RDD[String], sc:SparkContext, label:String)=
  {
    ...
    groupWordsNoSentLabelsSentwordnetTweet.saveAsTextFile(PrParameters.projectFolder+label+"WordsNoSentimentImplCombDist.csv")
    ...
    groupWordsNoSentLabelsDistSupTweet.saveAsTextFile(PrParameters.projectFolder+label+"WordsNoSentimentOrigCombDist.csv")
